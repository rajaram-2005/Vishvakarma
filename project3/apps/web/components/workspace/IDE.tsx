'use client';
// Aetherion IDE — File Tree | Code Editor | AI Agent
...
export function IDE() {
  ...
  const [termLines, setTermLines] = useState<string[]>(['Aetherion sandbox terminal — type "help". Everything dangerous is policy-gated.']);
  ...
  const runPipeline = async () => {
    ...
    const steps: Array<{ name: string; fn: () => void | Promise<void> }> = [
      ...
      },
      {
        name: 'Coder',
        fn: () => {
          const code = `// generated by Aetherion autonomous pipeline
// goal: ${goal}
