'use client';
// Aetherion — the ecosystem: one central node, fourteen orbits,
...
export function EcosystemGraph({ onNodeClick }: { onNodeClick?: (id: string) => void }) {
  ...
  return (
    <div className="relative w-full" style={{ aspectRatio: '1000/640' }}>
      <svg viewBox="0 0 1000 640" className="w-full h-full" role="img" aria-label="Aetherion ecosystem map">
        <defs>
