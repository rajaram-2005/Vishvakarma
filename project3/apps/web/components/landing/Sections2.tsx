'use client';
// Lumen landing — Agents · Teams · Skills · Memory · RAG · Tools.
...
export function MemorySection() {
  const items = [
    ['fact', 'Project 3 is codenamed Lumen — the open AI ecosystem workspace.'],
...
export function RagSection() {
  ...
  const doc = useMemo(() => ingestText('Lumen Design Principles', SAMPLE_DOC_TEXT, 'bundled document', 'text'), []);
  ...
  return (
    <LandingSection
      ...
      sub="Documents, websites, GitHub, databases, APIs and folders flow through one pipeline. Embeddings and reranking run locally; generation cites its sources. This demo is live — it just ingested the Lumen design document into your browser."
    >
