'use client';
// Lumen landing — Hero · AI Core · Ecosystem · Models · Routing.
    ...
    <header className="fixed top-0 inset-x-0 z-50">
      <div className="glass mx-auto mt-4 max-w-5xl flex items-center justify-between px-5 py-3 !rounded-full">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <span className="font-display font-semibold tracking-[0.3em] text-sm">Lumen</span>
        </Link>
...
export function CoreSection() {
  return (
    <LandingSection
      ...
      sub="Lumen fuses a local-first AI workspace with the embedded Aetheris intelligence core. Every model, agent, tool and workflow ties together in one place — and it runs on your machine first. Nothing here requires a cloud account."
    >
      <div className="glass relative overflow-hidden !rounded-[28px]">
        ...
        <div className="relative z-10 grid md:grid-cols-3 gap-4 p-6 md:p-8 min-h-[420px] items-center pointer-events-none">
          <div className="glass-2 p-5 max-w-[240px] md:mr-auto self-start">
            ...
            <div className="text-xs mt-2" style={{ color: 'var(--dim)' }}>Lumen Local always available. Connect Ollama or an API and the core routes automatically.</div>
          </div>
          <div />
...
const SAMPLE_PROMPTS = [
  ...
  'What is 17 × 23 + 5?',
  'Summarize the Lumen design principles document',
