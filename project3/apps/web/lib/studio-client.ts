...
export const studioClient = {
  ...
  activity: () => api<{ items: Array<{ id: string; at: string; kind: string; text: string }> }>('GET', '/api/activity'),
  notifications: () => api<{ items: Array<{ id: string; at: string; kind: string; text: string }> }>('GET', '/api/notifications'),
